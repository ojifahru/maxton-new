$(document).ready(function () {
    ...
    $('.delete-invited-speaker-btn').on('click', function() {
            ...
            $('#deleteInvitedSpeakerForm').attr('action', `${base_url}/admin/invited_speakers/delete/${invitedSpeakerId}`);
            $('#deleteInvitedSpeakerModal .modal-body p').html(`Are you sure you want to delete <strong>${invitedSpeakerName}</strong>?`);
        });
});

// Edit Invited Speaker Modal
document.addEventListener("DOMContentLoaded", function() {
    var editInvitedSpeakerModal = document.getElementById('editInvitedSpeakerModal');
    ...
    editInvitedSpeakerModal.addEventListener('show.bs.modal', function(event) {
        ...
        var invitedSpeakerDescription = button.getAttribute('data-invited-speaker-description');
        ...
        document.getElementById('edit-invited-speaker-name').value = invitedSpeakerName;
        document.getElementById('edit-invited-speaker-description').value = invitedSpeakerDescription;

        // Set preview image
        var imagePreview = document.getElementById('edit-invited-speaker-preview');
        if (invitedSpeakerImage) {
            imagePreview.src = base_url + "/uploads/invited_speakers/" + invitedSpeakerImage;
        ...
        document.getElementById('editInvitedSpeakerForm').action = base_url + "/admin/invited_speakers/update/" + invitedSpeakerId;
    });
});
