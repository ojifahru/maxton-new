...
<?php if (empty($invited_speakers)) : ?>
    <div class="col">
        <div class="card">
            <div class="card-body">
                <p class="text-center">No invited speakers found.</p>
            </div>
        </div>
    </div>
<?php endif; ?>
            ...
            <div class="card h-100 rounded-4 d-flex flex-column">
                <div class="col-12 d-flex g-0 align-items-center h-100">
                    <div class="col-md-4 border-end d-flex align-items-center">
                        <div class="p-3 w-100">
                            <img src="<?= base_url('uploads/invited_speakers/' . esc($invited_speaker['image'])) ?>" class="w-100 rounded-start" alt="<?= esc($invited_speaker['name']) ?>">
                        </div>
                    </div>
                    <div class="col-md-8 d-flex flex-column">
                        <div class="card-body flex-grow-1">
                            <h5 class="card-title"><?= esc($invited_speaker['name']) ?></h5>
                            <p class="card-text"><?= esc($invited_speaker['description']) ?></p>
                        </div>
