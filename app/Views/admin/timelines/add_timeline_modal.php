...
<div class="modal fade" id="addTimelineModal" tabindex="-1" aria-labelledby="addTimelineModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="<?= route_to('timelines.store') ?>" method="post" enctype="multipart/form-data" id="addTimelineForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 form-group">
                        ...
                        <input type="date" class="form-control date-format" id="date" name="date" required>
                    </div>
                    <div class="mb-3 form-group">
